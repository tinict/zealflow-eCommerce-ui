...
function RegisterPage() {
  return (
    <div className="bg-white min-w-[420px] p-10 rounded-md shadow-2xl flex flex-col gap-4 item-center z-50">
      ...
      <p className="text-[32px] text-main text-center font-semibold mb-4">Đăng ký</p>
      ...
      <Button className="bg-main h-[40px] rounded-none text-white font-normal">Đăng ký</Button>
      <p>
        Bạn đã có tài khoản Echop? <Link className="text-main" href={siteConfig.routes.login}>Đăng nhập</Link>
      </p>
    </div>
  );
}
